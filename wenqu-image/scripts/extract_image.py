...
Vendored from agentspace-so/agent-skills, gpt-image-2/scripts/extract_image.py
(MIT License). Source: https://github.com/agentspace-so/agent-skills/tree/main/gpt-image-2
"""
