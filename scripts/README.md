...
- `VERSION`, `package.json`, the OpenClaw manifest, the Claude plugin manifest,
  and the shared Claude/WorkBuddy marketplace manifest use the same package version;
